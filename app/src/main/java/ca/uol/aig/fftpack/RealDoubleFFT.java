...
*/
     ...
     {
         if(x.length != ndim)
              throw new IllegalArgumentException("The length of data (" + Integer.toString(x.length)
            		  + ") does not match that of the wavetable (" + Integer.toString(ndim) + ")");
...
*/
     ...
     {
         if(x.length != ndim)
              throw new IllegalArgumentException("The length of data does not match that of the wavetable");
         rfftf(ndim, x, wavetable);
